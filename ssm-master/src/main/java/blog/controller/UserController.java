...
public class UserController extends BaseController {
	...
	public AjaxResult createUserAction(String username, String password) {
		 ...
		 String tel="";
		 String  address="";
		 System.out.println(username+"123456"+password);
		int num= userService.createUser( username, password, des, tel, address);
		AjaxResult ajax=null;

		if(num<0){
			ajax= AjaxResult.getuser();
		}else{
			ajax= AjaxResult.getOK();
		}
		return ajax;
	}
